...
void test_ecb(void){
    ...
    wbcrypto_wbsm4_se_ecb_encrypt(ctx, input, 32, output);
    printf("\nwbsm4se_ecb\n");
    dump_hex(output, 32);
...
void test_cbc(void){
    ...
    wbcrypto_wbsm4_se_cbc_encrypt(ctx, iv_enc, input, 32, output);
    printf("\nwbsm4se_cbc\n");
    dump_hex(output, 32);
...
void test_ctr(void){
    ...
    wbcrypto_wbsm4_se_ctr_encrypt(ctx, iv_enc1, ecount_buf1, &num1, input, 32, output);
    printf("\nwbsm4se_ctr\n");
    dump_hex(output, 32);
...
void test_gcm(void){
    ...
    wbcrypto_wbsm4se_context *ctx = malloc(sizeof(wbcrypto_wbsm4se_context));
    wbcrypto_wbsm4_se_gen(ctx, key);
    WBCRYPTO_GCM128_CONTEXT *gcm_ctx = malloc(sizeof(WBCRYPTO_GCM128_CONTEXT));//自等价白盒SM4的GCM
    ...
    wbcrypto_wbsm4_se_gcm_encrypt(gcm_ctx, input, 32, output);//白盒自等价SM4加密
    printf("\nwbsm4se_gcm\n");
    dump_hex(output, 32);
