...
typedef WBCRYPTO_GCM128_CONTEXT  SM4_GCM128_CONTEXT;
...
extern "C" {
    ...
    */
    ...
    /**
    * \brief          This function performs an SM4-CBC encryption or decryption operation on full blocks.
    *
    * \param ctx      The SM4 context to use for encryption or decryption.
    *                 It must be initialized and bound to a key.
    * \param mode     The SM4 operation: #WBCRYPTO_SM4_ENCRYPT or #WBCRYPTO_SM4_DECRYPT
    ...
    */
    ...
    int wbcrypto_sm4_gcm128_setiv(SM4_GCM128_CONTEXT *gcm_ctx, const unsigned char *iv,
                                size_t ivlen);
    int wbcrypto_sm4_gcm128_aad(SM4_GCM128_CONTEXT *gcm_ctx, const unsigned char *aad,
                                size_t len);
    int wbcrypto_sm4_gcm128_crypt(SM4_GCM128_CONTEXT *gcm_ctx, const int mode, const unsigned char *in, size_t length,
                                unsigned char *out);  
